...
/**
 * Test de l'API des fournisseurs après correction du problème deliveryTerms
 */

const API_BASE_URL = 'http://localhost:3001';

async function testAPI() {
  console.log('🧪 TEST DE L\'API FOURNISSEURS APRÈS CORRECTION\n');
  ...
  try {
    ...
    const newSupplier = {
      ...
      isActive: true,
      isPreferred: false,
      notes: 'Fournisseur de test après correction',
      tags: ['test', 'fixed']
    };
